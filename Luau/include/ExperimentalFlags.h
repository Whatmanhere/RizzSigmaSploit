...
inline bool isFlagExperimental(const char* flag)
{
    ...
    static const char* const kList[] = {
        "../includeInstantiateInSubtyping",      // requires some fixes to lua-apps code
        "../includeFixIndexerSubtypingOrdering", // requires some small fixes to lua-apps code since this fixes a false negative
